...
const UI = {
  cn: {
    ...
    "page.parts.sub": "从车架前叉到变速刹车，全系国产一线配套，零件护照可追溯。",
    ...
    "home.line2Desc": "从车架前叉到变速刹车，全系国产一线配套，零件护照可追溯。",
    "home.line2M1": "零配件",
    "home.line2M2": "系统",
    "home.line2M3": "品牌",
    "home.line3Title": "户外",
    ...
    "home.bikesSub": "入门到竞赛，同一套「透明 BOM + 国产一线 + 可升级」逻辑。",
    ...
    "about.sandoBody": "每辆 SANDO 整车都附「零件护照」：公开全部零件的品牌、型号与山度加价率。全系采用蓝图 1×12 变速、KMC 链条、日晖飞轮、久裕轮组——国产 ≠ 低端。基础整车 + 模块化升级包（轮组 / 变速 / 刹车），标准化 Boost 148/110 与 BSA 接口，随骑行水平一起成长。",
    "about.sandoBtn": "查看车型 →",
    ...
    "footer.manual": "使用手册",
    "footer.tagline": "SANDO × terrain-x · 透明 BOM · 国产一线配套",
  },
  en: {
    "nav.home": "Home",
    "nav.bikes": "Bikes",
